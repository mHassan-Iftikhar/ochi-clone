...
const Footer = () => {
  return (
    <>
    <div className='w-full h-[95vh] bg-[#F1F1F1] px-20 flex flex-col'>
        <div className='w-full flex justify-between'>
        <div className='eyeOpening w-1/2 font-[Founders_Grotesk_X]'>
            <h1 className='w-20 leading-30 text-[8.5vw] font-medium text-[#212121] uppercase'>{`Eye-Opening`}</h1>
        </div>
        <div className='presentations w-1/2 font-[Founders_Grotesk_X]'>
            <h1 className='w-20 leading-30 text-[8.5vw] font-medium text-[#212121]'>{`PRESENTATIONS`}</h1>
        ...
        <div className='h-full flex items-center justify-between'>
            ...
            <div className='flex justify-between gap-85'>
                <h5>© ochi design 2025. Legal Terms</h5>
                <h5>Website by Obys</h5>
            </div>
        </div>
    </div>
    </>
